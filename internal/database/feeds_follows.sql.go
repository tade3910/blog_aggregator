...
SELECT id, created_at, updated_at, feed_id, user_id FROM feeds_follows
WHERE user_id = $1
ORDER BY updated_at
`

func (q *Queries) GetAllUserFeedFollows(ctx context.Context, userID uuid.UUID) ([]FeedsFollow, error) {
